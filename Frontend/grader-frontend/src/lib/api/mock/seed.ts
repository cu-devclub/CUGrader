...
export async function seed(client: APIClient) {
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-07-05T23:59'),
    examPin: "456789",
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-07-10T20:00'),
    examPin: "321654",
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-07-12T16:00'),
    examPin: "987321",
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-07-20T23:59'),
    examPin: "111111",
    showScoreOnLock: true,
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-07-25T23:59'),
    examPin: "222222",
    showScoreOnLock: true,
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-08-01T23:59'),
    examPin: "333333",
    showScoreOnLock: true,
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-08-05T23:59'),
    examPin: "444444",
  ...
  await client.assignments.create(420, {
    ...
    due: parseDateTime('2026-08-10T23:59'),
    examPin: "555555",
