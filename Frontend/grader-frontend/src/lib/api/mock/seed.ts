    ...
    questions: [
      {
        ...
        testcases: [{ input: "10 2 5", expectedOutput: "Just 1.0" }, { input: "10 0 5", expectedOutput: "Nothing" }],
        secretTestCases: [{ input: "20 4 2", expectedOutput: "Just 2.5" }]
      },
      {
        number: 2,
        name: "IO Monad",
        ...
        secretTestCases: [{ input: "abc", expectedOutput: "Invalid input" }]
      }
    ],
  });
  await client.assignments.create(420, {
    ...
    questions: [
      {
        ...
        secretTestCases: [{ input: "isEmpty", expectedOutput: "true" }]
      },
      {
        number: 2,
        ...
        secretTestCases: [{ input: "[3,1,2,1,3]", expectedOutput: "[1,2,3]" }]
      }
    ],
  });
    ...
    questions: [
      {
        ...
        testcases: [{ input: "7", expectedOutput: "true" }, { input: "4", expectedOutput: "false" }],
        secretTestCases: [{ input: "97", expectedOutput: "true" }, { input: "100", expectedOutput: "false" }]
      },
      {
        number: 2,
        ...
        testcases: [{ input: "obj.a.b.c", expectedOutput: "42" }],
        secretTestCases: [{ input: "obj.a.x", expectedOutput: "undefined" }]
      }],
  });
    ...
    questions: [
      {
        ...
        testcases: [{ input: "[1,2,3]", expectedOutput: "LinkedList with 3 elements" }],
        secretTestCases: [{ input: "insert(1, 5)", expectedOutput: "[1,5,2,3]" }]
      }
    ],
  });
  await client.assignments.create(420, {
    ...
    questions: [
      {
        ...
        testcases: [{ input: "insert(5,3,7)", expectedOutput: "in-order: [3,5,7]" }],
        secretTestCases: [{ input: "delete(3)", expectedOutput: "in-order: [5,7]" }]
      }
    ],
  });
  await client.assignments.create(420, {
    ...
    questions: [
      {
        ...
        testcases: [{ input: "BFS from A", expectedOutput: "['A', 'B', 'C']" }],
        secretTestCases: [{ input: "dijkstra from A to C", expectedOutput: "distance: 3" }],
        languageIds: [6, 1, 4, 2, 7, 8, 9]
      }
    ],
  });
    ...
    questions: [
      {
        ...
        testcases: [{ input: "fibonacci(10)", expectedOutput: "55" }],
        secretTestCases: [{ input: "knapsack([10,20,30], [60,100,120], 50)", expectedOutput: "220" }],
        languageIds: [6, 1, 4, 2, 7, 8, 9]
      }
    ],
  });
    ...
    questions: [
      {
        ...
        testcases: [{ input: "insert('apple'), search('app')", expectedOutput: "true" }],
        secretTestCases: [{ input: "getWordsWithPrefix('ap')", expectedOutput: "['app', 'apple']" }],
        languageIds: [6, 1, 4, 2, 7, 8, 9]
      },
      {
        number: 2,
        ...
        secretTestCode: "expect(ds.getComponentSize(1)).toBe(2);\nexpect(ds.getNumberOfComponents()).toBe(2);\nexpect(ds.getComponent(1)).toContain(2);", testcases: [{ input: "union(1,2), connected(1,2)", expectedOutput: "true" }],
        secretTestCases: [{ input: "getComponentSize(1)", expectedOutput: "2" }],
        languageIds: [6, 1, 4, 2, 7, 8, 9]
      }
    ]
  });
